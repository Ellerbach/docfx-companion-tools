...
namespace DocLinkChecker.Models
{
    ...
    public class CommandLineOptions
    {
        ...
        /// </summary>
        [Option('d', "docfolder", Group = "Documents", Required = false, HelpText = "Folder containing the documents.")]
        public string DocFolder { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the configuration file.
        /// </summary>
        [Option('f', "config", Group = "Documents", Required = false, HelpText = "Configuration file to load for settings.")]
