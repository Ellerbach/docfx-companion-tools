namespace DocLinkChecker.Test
{
    ...
    {
        public static string CorrectDocument = @"# Correct Document
...
Consequat nisl vel pretium lectus quam id. Dolor purus non enim praesent elementum. Orci porta non pulvinar neque laoreet suspendisse interdum consectetur libero. Quisque id diam vel quam elementum pulvinar etiam non quam. Dignissim cras tincidunt lobortis feugiat vivamus. In eu mi bibendum neque egestas congue quisque. Mauris sit amet massa vitae tortor condimentum. Nunc non blandit massa enim nec dui. Purus sit amet luctus venenatis lectus magna fringilla urna. Arcu vitae elementum curabitur vitae nunc sed velit dignissim. Risus viverra adipiscing at in tellus. Commodo quis imperdiet massa tincidunt nunc pulvinar sapien et. Et sollicitudin ac orci phasellus egestas tellus rutrum. Vitae congue mauris rhoncus aenean vel elit scelerisque mauris.";
        ...
        public static string ErrorDocument = @"# Error Document
This is a sample document to verify the correct extraction of the links. However, we have an invalid table!
...
| Some data | Link | Other data |
| -- | --- | --- |
| Microsoft       | https://www.microsoft.com => incorrect number of columns |
| .NET Foundation | https://dotnetfoundation.org/ | [FAQ](https://dotnetfoundation.org/about/faq) => we're missing a pipe character here
| Github          | https://github.com/           | [Blog](https://github.blog/)                  |

Consequat nisl vel pretium lectus quam id. Dolor purus non enim praesent elementum. Orci porta non pulvinar neque laoreet suspendisse interdum consectetur libero. Quisque id diam vel quam elementum pulvinar etiam non quam. Dignissim cras tincidunt lobortis feugiat vivamus. In eu mi bibendum neque egestas congue quisque. Mauris sit amet massa vitae tortor condimentum. Nunc non blandit massa enim nec dui. Purus sit amet luctus venenatis lectus magna fringilla urna. Arcu vitae elementum curabitur vitae nunc sed velit dignissim. Risus viverra adipiscing at in tellus. Commodo quis imperdiet massa tincidunt nunc pulvinar sapien et. Et sollicitudin ac orci phasellus egestas tellus rutrum. Vitae congue mauris rhoncus aenean vel elit scelerisque mauris.";

        public static List<Hyperlink> CorrectDocumentCorrectLinks = new()
        {
            new Hyperlink(string.Empty, 4, 1, "https://loremipsum.io/generator/?n=5&t=p"),
            new Hyperlink(string.Empty, 4, 644, "http://ww1.microchip.com/downloads/en/devicedoc/21295c.pdf"),
            new Hyperlink(string.Empty, 8, 28, "https://www.hanselman.com/blog/RemoteDebuggingWithVSCodeOnWindowsToARaspberryPiUsingNETCoreOnARM.aspx"),
            new Hyperlink(string.Empty, 14, 21, "https://www.microsoft.com"),
            new Hyperlink(string.Empty, 14, 53, "https://blogs.microsoft.com/"),
            new Hyperlink(string.Empty, 15, 21, "https://dotnetfoundation.org/"),
            new Hyperlink(string.Empty, 15, 53, "https://dotnetfoundation.org/about/faq"),
            new Hyperlink(string.Empty, 16, 21, "https://github.com/"),
            new Hyperlink(string.Empty, 16, 53, "https://github.blog/"),
        };

        public static List<Hyperlink> CorrectDocumentErrorLinks = new()
        {
            new Hyperlink(string.Empty, 6, 12, "https://xyzdoesnotexist.com/blah"),
            new Hyperlink(string.Empty, 6, 342, "./Document1.md"),
        };

        public static List<Heading> CorrectDocumentHeadings = new()
        {
            new Heading(string.Empty, 1, 1, "Correct Document", "correct-document"),
        };

        public static List<Heading> ErrorDocumentHeadings = new()
        {
            new Heading(string.Empty, 1, 1, "Error Document", "error-document"),
        };

        public static List<MarkdownError> ErrorDocumentErrors = new()
        {
            new MarkdownError(string.Empty, 13, 1, MarkdownErrorSeverity.Error, "Second line of a table"),
            new MarkdownError(string.Empty, 14, 1, MarkdownErrorSeverity.Error, "must have 3 columns"),
            new MarkdownError(string.Empty, 15, 135, MarkdownErrorSeverity.Error, "end with a pipe character"),
        };
    }
}
